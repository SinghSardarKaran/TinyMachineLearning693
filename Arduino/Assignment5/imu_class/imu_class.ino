...
Eloquent::ML::Port::Classifier rdf; //clf is your model instance
...
void loop() {
    ...
    delay(20);
    Serial.println(rdf.predict(features)); //predict with your new features and print the outcome
}
